        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="form-section">
                    ...
                    <form action="insertService" method="POST" name="applyServices">
                        <div class="form-group form-box">
                            <input type="text" name="ownerName" class="input-text" placeholder="Owner's Name" required>
                            <i class="fa fa-user"></i>
                        </div>
                        <div class="form-group form-box">
                            <input type="text" name="ownerMobileNo" class="input-text" placeholder="Mobile Number"required>
                            <i class="fa fa-user"></i>
                        </div>
                        <div class="form-group form-box">
                ...
                <div class="form-group form-box">
                        <select class="form-control search-fields" name="serviceRequired" required>
                        <option selected="true" disabled="disabled">Services Required</option>
                        ...
                        <div class="form-group form-box">
                            <input type="text" name="modelYear" class="input-text" placeholder="Model Year" required>
                            <i class="fa fa-user"></i>
                        </div>
                          <div class="form-group form-box">
                        <select class="form-control search-fields" name="slot" required>
                        <option selected="true" disabled="disabled">Time Slot</option>
                        ...
                        <div class="form-group mb-0 clearfix">
                            <button type="submit" class="btn-md btn-theme float-left">Book Service</button>
                        </div>

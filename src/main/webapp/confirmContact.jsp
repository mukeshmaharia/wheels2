...
<div class="contact-2 content-area-5">
    <div class="container">
        ...
        <div class="main-title text-center">
            <h1>Your query has been <span>received!</span></h1>
        </div>
        <form action="/wheels2">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-md-6 text-left">
                            ...
                            <span>Dear ${i.name } thank you for contacting us.	  </span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group email">
							<span>Your query will be resolved soon regarding:${i.subject } </span>                 
			           </div>
                        </div>                                            
                    </div>
                </div>

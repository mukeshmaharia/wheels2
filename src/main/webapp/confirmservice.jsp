...
<div class="contact-2 content-area-5">
    <div class="container">
        ...
        <div class="main-title text-center">
            <h1>Service Booking  <span>Confirmed</span></h1>
            <p>Thank you for being with us.Your car service slot has been booked successfully!</p>
        </div>
        <form action="/wheels2">
            <div class="row">

        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-7">
                <div class="list-inline">
                    ...
                    <a href="tel:info@wheels.com"><i class="fa fa-envelope"></i>info@wheels.com</a>
                    <a href="tel:info@wheels.com"><i class="fa fa-clock-o"></i>Mon - Sun: 8:00am - 6:00pm</a>
                </div>
            </div>
        ...
        <div class="carousel-inner banner-slider-inner text-center">
            <div class="carousel-item banner-max-height active item-bg">
                ...
                <div class="carousel-content container banner-info-2 bi-2 text-left">
                    ...
                    <a href="https://www.tatamotors.com/" class="btn btn-lg btn-theme">Read more</a>
                </div>
            </div>
            <div class="carousel-item banner-max-height item-bg">
                <img class="d-block w-100 h-100" src="img/car-2.webp" alt="banner">
                <div class="carousel-content container banner-info-2 bi-2 text-left">
                    <h3>Explore Your Dream Car</h3>
                    <h5>Allow us to guide you through the innovative stress<br>
                        free approach in finding your dream car.</h5>
                    <a href="https://www.mahindra.com/" class="btn btn-lg btn-theme">Read more</a>
                </div>
            </div>
            <div class="carousel-item banner-max-height item-bg">
                ...
                <div class="carousel-content container banner-info-2 bi-2 text-left">
                    ...
                    <h5>Allow us to guide you through the innovative stress<br>
                        free approach in finding your dream car.</h5>
                    <a href="https://www.toyotabharat.com/" class="btn btn-lg btn-theme">Read more</a>
                </div>
            </div>
        </div>
        <!-- Search box 3 start -->
            ...
            <div class="row slick-carousel" data-slick='{"slidesToShow": 3, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="car-box-3">
                        ...
                        <div class="detail">
                            <h1 class="title">
                                <a href="car-details.html">Lamborghini Hurac�n</a>
                            </h1>
                            <div class="location">
                                ...
                                <div class="overlap-box">
                                    <div class="overlap-btns-area">
                                        <div class="car-magnify-gallery">
                                            ...
                                            <a href="img/car/car-1.jpg" class="hidden" data-sub-html="<h4>Lamborghini Hurac�n</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
